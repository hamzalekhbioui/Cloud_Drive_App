...
export default function RegisterPage() {
  ...
  const formValid = nameOk && emailOk && passwordOk
        ...
        >
          <motion.div variants={containerVariants} initial="hidden" animate="show">
            ...
            <motion.p variants={itemVariants} className="gl-subhead">
              Start your 14-day Business trial.
            </motion.p>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <motion.div variants={itemVariants} style={{ marginBottom: 20 }}>
                <label className="gl-label" htmlFor="gl-name">Full name</label>
                <input
                  id="gl-name"
                  type="text"
                  autoComplete="name"
                  ...
                  className={`gl-input${nameErr ? ' err' : ''}${nameOk && touched.name ? ' ok' : ''}`}
                />
              ...
              <motion.div variants={itemVariants}>
                <button type="submit" className="gl-btn-primary" disabled={isLoading}>
                  {submitting ? <><SpinnerIcon /> Creating account…</> : 'Create account'}
                </button>
              </motion.div>
